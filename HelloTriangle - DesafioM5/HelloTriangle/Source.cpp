...
{
	glfwInit();
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Tarefa M5 - Lucas Barreto Telch", nullptr, nullptr);
	...
	GLuint texID = loadTexture("../../Textures/DesafioM5/boneco.png", imgWidth, imgHeight);
	...
	GLuint texID2 = loadTexture("../../Textures/DesafioM5/fundo.png", imgWidth, imgHeight);

	fundo.inicializar(texID2, 1, 1, glm::vec3(400.0,300.0,0.0), glm::vec3(imgWidth/1.8,imgHeight/1.8,1.0),0.0,glm::vec3(0.0,1.0,1.0));
